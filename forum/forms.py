...
class TopicSplitForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        posts = self.topic.posts.order_by('date').select_related('profile', 'profile__user', 'profile__forum_group', 'topic', 'topic__first_post')
...
class PostMoveForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        posts = self.topic_src.posts.order_by('date').select_related('profile', 'profile__user', 'profile__forum_group', 'topic', 'topic__first_post')
