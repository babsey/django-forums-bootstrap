...
urlpatterns = patterns('django.contrib.auth.views',
    ...
    (r'^password_change/done/$', 'password_change_done',
        {'template_name': 'password_change/password_change_done.html'}, 'password_change_done'),
    ...
    (r'^password_reset/done/$', 'password_reset_done',
        {'template_name': 'password_reset/password_reset_done.html'}, 'password_reset_done'),
...
urlpatterns += [
    ...
    url(r'^registration/done/$', TemplateView,
        {'template': 'registration/registration_done.html'}, name='registration_done'),
    url(r'^registration/(?P<uidb36>[0-9A-Za-z]{1,13})-(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', views.registration_confirm, name='registration_confirm'),
    url(r'^registration/failed/$', TemplateView,
    ...
    url(r'^registration/complete/$', TemplateView,
    ...
    url(r'^email_change/done/$', TemplateView,
    ...
    url(r'^email_change/complete/$', TemplateView,
        {'template': 'email_change/email_change_complete.html'}, name='email_change_complete'),
    url(r'^email_change/failed/$', TemplateView,
